...
def sparse_continents
  # Find every country that 
  # belongs to a continent where each country's
  # WHERE continent IN subquery
  # subquery: continents with every country population < 25,000,000. 
...
# Subquery: country with max population inside the continent is less than 25
# GROUP BY continent
# HAVING
#   MAX(population) < 25
